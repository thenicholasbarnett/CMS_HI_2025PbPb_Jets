...
TString htitles_byhibin[nhiBin] = {"0 < hiBin < 20", "20 < hiBin < 60", "60 < hiBin < 100", "100 < hiBin < 160", "160 < hiBin < 200"};
TString shiBins[nhiBin] = {"_hiBin_0_to_20", "_hiBin_20_to_60", "_hiBin_60_to_100", "_hiBin_100_to_160", "_hiBin_160_to_200"};

// |eta|
const int netabins = 3;
const float etalo[netabins] = {0.0, 0.0, 0.0};
const float etahi[netabins] = {0.5, 2.4, 5.0};
TString htitles_byeta[netabins] = {"|#eta| < 0.5", "|#eta| < 2.4", "|#eta| < 5"};
