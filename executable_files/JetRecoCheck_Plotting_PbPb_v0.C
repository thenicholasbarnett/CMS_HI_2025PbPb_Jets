...
void JetRecoCheck_Plotting_PbPb_v0(){
    ...
    // reading input file
    // TString input = "../11_8_2025/JetRecoCheck_2024PbPbMC_11_7_2025.root";
    // TString input = "../11_8_2025/JetRecoCheck_2024PbPbMC_11_7_2025_id.root";
    TString input1 = "../11_8_2025/JetRecoCheck_2025PbPbMC_11_7_2025_noDM.root";
    // TString input = "../11_8_2025/JetRecoCheck_2025PbPbMC_11_7_2025_noDM_id.root";
    TString input0 = "../11_8_2025/JetRecoCheck_2025PbPbMC_11_7_2025_withDM.root";
    // TString input = "../11_8_2025/JetRecoCheck_2025PbPbMC_11_7_2025_withDM_id.root";
    TFile *fi0 = TFile::Open(input0,"read");
    if(!fi0){cout<< "ERROR: Could not find file "<<input0<<endl; return;}
    TFile *fi1 = TFile::Open(input1,"read");
    if(!fi1){cout<< "ERROR: Could not find file "<<input1<<endl; return;}
    ...
    for(unsigned int b=0; b<netabins; b++){
        ...
        for(int hj=0; hj<nmom; hj++){
            TString htitle0 = path_inc+smom[hj]+sEtaBin;
        ...
        TString htitle1 = path_inc+"hjtetaphi"+sEtaBin;
        ...
        for(int hj=0; hj<nfrac; hj++){
            ...
            TString htitle2 = path_inc+sfrac[hj]+sEtaBin;
            ...
            TString htitle3 = path_inc+smult[hj]+sEtaBin;
    ...
    for(unsigned int b=0; b<netabins; b++){
        ...
        for(unsigned int hb=0; hb<nhiBin; hb++){
            ...
            if(flag_epr==1){save_2dr_byhibin(hjtetaphi_hibin_ratio, b, hb, htitles_mom_xaxis[2], htitles_mom_xaxis[3], shiBins[hb], "jet_eta_phi"+sEtaBin+shiBin, pathr_ep);}
            for(int hj=0; hj<nfrac; hj++){
