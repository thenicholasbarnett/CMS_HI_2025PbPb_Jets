...
# with command line options: recoPbPbrawPr2mini --conditions 151X_dataRun3_Prompt_v1 -s RAW2DIGI,L1Reco,RECO,PAT --datatier MINIAOD --eventcontent MINIAOD --data --process RECO --scenario pp --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run3 --no_exec --era Run3_pp_on_PbPb_approxSiStripClusters_2025 --repacked --nThreads 8 -n -1
...
process = cms.Process('RECO',Run3_pp_on_PbPb_approxSiStripClusters_2025)
...
process.source = cms.Source("NewEventStreamFileReader",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/t0streamer/Data/PhysicsHIPhysicsRawPrime0/000/399/499/run399499_ls0193_streamPhysicsHIPhysicsRawPrime0_StorageManager.dat')
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('recoPbPbrawPr2mini nevts:-1'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('recoPbPbrawPr2mini_RAW2DIGI_L1Reco_RECO_PAT.root'),
...
process.MINIAODoutput.outputCommands += ['keep *_hcalDigis_*_*', 'keep *_caloStage2Digis_CaloTower_*', 'keep *_ecalDigis_EcalTriggerPrimitives_*']
